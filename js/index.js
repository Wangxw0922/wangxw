    ...
    series: [
      {
        ...
        type: "bar",
        barWidth: "35%",
        data: [200, 460, 1000, 850, 1500, 1200, 600],
        itemStyle: {
          // 修改柱子圆角
          barBorderRadius: 5,
        },
        ...
        areaStyle: {
          ...
          color: new echarts.graphic.LinearGradient(
            ...
            [
              {
                offset: 0,
                color: "rgba(1, 132, 213, 0.4)", // 渐变色的起始颜色 上面
              },
              {
                offset: 0.8,
                color: "rgba(1, 132, 213, 0.1)", // 渐变线的结束颜色  下面
              },
            ],
            false
          ),
